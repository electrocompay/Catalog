...
+(NSArray *)chairModels
{
    if (!_chairModels) {
        _chairModels = [[NSArray alloc] initWithObjects:
                        ...
                        [[[IWModel modelWithName:@"Largo-U" andCode:@"Largo-U-CC-LL" andFile:@"Largo-U-01-22.jpg" andColors:@"01,02,03,04,05,06,07,08,09,10,11,12,13,14,16,17,18" andLegColors:@"22,23,24,25,26"] withPriceFormat:@"%@-%@-%@"] withCategory:@"model"],
