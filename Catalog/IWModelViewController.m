...
//    }
    ...
    [tableTopSize setImage:[UIImage imageNamed:[[imageName uppercaseString] stringByAppendingString:@"p.png"]]];
    [tableFrontSize setImage:[UIImage imageNamed:[[imageName uppercaseString] stringByAppendingString:@"a.png"]]];
